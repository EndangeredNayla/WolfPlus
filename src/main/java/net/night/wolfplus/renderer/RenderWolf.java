...
public class RenderWolf extends RenderLiving
{
    ...
    protected float getTailRotation(EntityWolf00 par1EntityWolf, float par2)
    {
        return par1EntityWolf.getTailRotation();
    }

    protected int func_82447_a(EntityWolf00 par1EntityWolf, int par2, float par3)
    {
        float var4;
    ...
    protected ResourceLocation func_110914_a(EntityWolf00 par1EntityWolf)
    {
    ...
    {
        return this.func_82447_a((EntityWolf00)par1EntityLivingBase, par2, par3);
    }

    protected float handleRotationFloat(EntityLivingBase par1EntityLivingBase, float par2)
    {
        return this.getTailRotation((EntityWolf00)par1EntityLivingBase, par2);
    }
	
    protected ResourceLocation getEntityTexture(Entity par1Entity)
    {
        return this.func_110914_a((EntityWolf00)par1Entity);
    }
}
