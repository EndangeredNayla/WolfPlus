...
public class EntityWolf00 extends EntityTameable
{
    ...
    public EntityWolf00(World par1World)
    {
        super(par1World);
    ...
    {
        EntityWolf00 var2 = new EntityWolf00(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityWolf00))
        {
            return false;
        }
        else
        {
            EntityWolf00 var2 = (EntityWolf00)par1EntityAnimal;
